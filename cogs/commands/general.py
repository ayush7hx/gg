...
class General(commands.Cog):
  ...
  @commands.command(name="users", help="checks total users of INF.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  ...
  async def invite(self, ctx: commands.Context):
      embed = discord.Embed(
          title="<:zyroxconnection:1448949425828528230> INF Integration Hub!",
      ...
      embed.set_footer(
          text=f"Powerd By Made by Ayush7hx",
