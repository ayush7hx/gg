...
class StatsDropdown(Select):
    def __init__(self, ctx, bot, embeds):
        ...
        super().__init__(placeholder="INF Statistics.", min_values=1, max_values=1, options=options)
...
class Stats(commands.Cog):
    ...
    async def stats(self, ctx):
        ...
        loading_embed = discord.Embed(title="", description="<a:loading:1448949404185657354> **Generating INF Statistics...**", color=0x00000)
        ...
        quick_embed = Embed(title="INF Stats Panel", color=0xFF0000)
        ...
        system_embed.set_footer(text="Devloped By Made by Ayush7hx", icon_url="https://cdn.discordapp.com/avatars/1396114795102470196/198b9bc616ec574f6fd2f7121a1d3abc.png?size=1024")
      ...
      #  general_embed.add_field(name="Latency", value=f"```[ Bot ]: {round(sh.latency * 800)}ms\n[ Database ]: 0.5ms```")
        ...
        general_embed.set_footer(text="Devloped By Made by Ayush7hx", icon_url="https://cdn.discordapp.com/avatars/1396114795102470196/198b9bc616ec574f6fd2f7121a1d3abc.png?size=1024")
        ...
        team_embed.set_footer(text="Developed By Made by Ayush7hx", icon_url="https://cdn.discordapp.com/avatars/1396114795102470196/198b9bc616ec574f6fd2f7121a1d3abc.png?size=1024")
        ...
        code_embed.add_field(name="Codebase Overview",
                             value=f"""**\n Files : {files}\n Lines : {lines}\n Words : {words}**""",
                             inline=False)
        code_embed.set_footer(text="Developed By Made by Ayush7hx", icon_url="https://cdn.discordapp.com/avatars/1396114795102470196/198b9bc616ec574f6fd2f7121a1d3abc.png?size=1024")
