...
class MentionDropdown(discord.ui.Select):
    def __init__(self, message: discord.Message, bot: commands.Bot, prefix: str):
        ...
        super().__init__(placeholder="Start With INF", min_values=1, max_values=1, options=options)
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed.set_footer(text="Powered by Made by Ayush7hx", icon_url=self.bot.user.avatar.url)
